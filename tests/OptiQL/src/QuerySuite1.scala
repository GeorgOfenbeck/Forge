...
object QueryableSelectRunnerS extends ForgeTestRunnerShallow with TestRec {
...
object QueryableReduceRunnerS extends ForgeTestRunnerShallow with TestRec {
  def main() = {
...
object QueryableGroupByRunnerS extends ForgeTestRunnerShallow with TestRec {
  def main() = {
...
object QueryableSortRunnerS extends ForgeTestRunnerShallow with TestRec {
  def main() = {
