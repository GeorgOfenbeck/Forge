...
trait LAPACKWrapper extends LAPACKWrapperBase with LAPACKWrapperImpl {
  this: AutoOptiLALib with AutoOptiLAApplication =>
}

trait LAPACKWrapperBase extends LinAlgWrapper {
  this: AutoOptiLABase with AutoOptiLAClasses with LAPACKOps =>
...
trait LAPACKWrapperImpl {
  this: AutoOptiLAApplication with AutoOptiLACompilerOps =>
