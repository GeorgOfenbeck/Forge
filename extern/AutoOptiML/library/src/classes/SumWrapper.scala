package autooptiml.library.classes
...
import autooptiml.shared.ops._
import autooptiml.shared.typeclass._
import autooptiml.library._
import autooptiml.library.classes._

trait SumWrapper {
  this: AutoOptiMLBase with AutoOptiMLClasses with CanSumOps =>
