import svector.compiler._
import svector.library._
import svector.shared._

object HelloSimpleCompiler extends SVectorApplicationCompiler with HelloSimple
object HelloSimpleInterpreter extends SVectorApplicationInterpreter with HelloSimple

trait HelloSimple extends SVectorApplication {
  def main() = {
    println("hello world")
