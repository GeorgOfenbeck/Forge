...
object NBCompiler extends AutoOptiMLApplicationCompiler with NaiveBayes
object NBInterpreter extends AutoOptiMLApplicationInterpreter with NaiveBayes

trait NaiveBayes extends AutoOptiMLApplication {
  def printUsage = {
