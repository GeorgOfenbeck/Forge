...
object GDACompiler extends AutoOptiMLApplicationCompiler with GDA
object GDAInterpreter extends AutoOptiMLApplicationInterpreter with GDA

trait GDA extends AutoOptiMLApplication {
  def printUsage = {
