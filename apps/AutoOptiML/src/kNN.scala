...
object kNNCompiler extends AutoOptiMLApplicationCompiler with kNN
object kNNInterpreter extends AutoOptiMLApplicationInterpreter with kNN

trait kNN extends AutoOptiMLApplication {
  def printUsage = {
