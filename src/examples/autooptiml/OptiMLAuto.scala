...
import autooptila.AutoOptiLADSL
import core.ForgeApplicationRunner

object AutoOptiMLDSLRunner extends ForgeApplicationRunner with AutoOptiMLDSL

trait AutoOptiMLDSL extends AutoOptiLADSL
  with SetOps with BufferableOps { this: ppl.dsl.forge.core.ForgeOpsExp =>

  override def dslName = "AutoOptiML"
