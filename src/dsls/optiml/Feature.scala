...
trait FeatureOps {
  ...
  def importFeatureOps() {
    ...
    static (ContinuousFeature) ("apply", Nil, (("default", MDouble, "unit(0.0209)"), ("min", MDouble, "math_ninf()"), ("max", MDouble, "math_inf()")) :: ContinuousFeature) implements allocates(ContinuousFeature, {
  ...
  s"""$arg1"""
    ...
    ContinuousFeatureOps {
      ...
      infix ("apply") (MString :: MDouble) implements composite {
          ...
          s"""if (self.default != 0.0209 && ($arg1 == "" || $arg1.toLowerCase == "null")) {
  $self.default
}
else {
  val num = $arg1.toDouble
  if (num < $self.min) { $self.min }
    ...
    compiler (DiscreteFeature) ("discrete_feature_alloc", Nil, (MHashMap(MString, MInt) :: DiscreteFeature)) implements allocates(DiscreteFeature, {
  val arg1 = quotedArg(0)
  s"""$arg1"""
})
...
discrete_feature_alloc(fhashmap_from_arrays(keys, values))"""
    ...
    DiscreteFeatureOps {
      ...
      infix ("apply") (MString :: MDouble) implements composite {
          val self = quotedArg("self")
          val arg1 = quotedArg(1)
          s"""val featureMap = getFeatures($self)
if (featureMap.contains($arg1)) featureMap($arg1).toDouble else 0.0"""
        }
...
val e = if (featureMap.contains($arg1)) featureMap($arg1).toDouble else 0.0
...
fhashmap_size(featureMap)"""
    ...
    static (BinaryFeature) ("apply", Nil, ("default", MBoolean, "unit(false)") :: BinaryFeature) implements allocates(BinaryFeature, {
  val arg1 = quotedArg(0)
  s"""$arg1"""
})
    ...
    BinaryFeatureOps {
      ...
      infix ("apply") (MString :: MDouble) implements composite {
          val arg1 = quotedArg(1)
          val self = quotedArg("self")
          s"""fassert($arg1 == "" || $arg1 == "0" || $arg1 == "1" || $arg1 == "false" || $arg1 == "true", "illegal input to binary feature")
if ($arg1 == "0" || $arg1 == "false") 0.0
else if ($arg1 == "1" || $arg1 == "true") 1.0
    ...
    static (DateFeature) ("apply", Nil, MString :: SDateFormat) implements codegen($cala, {
        val arg1 = quotedArg(0)
        s"""org.joda.time.format.DateTimeFormat.forPattern($arg1)"""
      })
    ...
    infix (DateFeature) ("apply", Nil, (SDateFormat, MString) :: MDouble) implements codegen($cala, {
        ...
        s"""try {
  $arg1.parseMillis($arg2).toDouble
}
catch {
  case e => 0.0 
}"""
    ...
    compiler (DateFeature) ("dt_internal", Nil, MDouble :: SDateTime) implements codegen($cala, {
        val arg1 = quotedArg(0)
        s"""new org.joda.time.DateTime($arg1.toLong)"""
      })
    ...
    compiler (DateFeature) ("dt_internal_days_between", Nil, (SDateTime, SDateTime) :: MInt) implements codegen($cala, {
        val arg1 = quotedArg(0)
        val arg2 = quotedArg(1)
        s"""org.joda.time.Days.daysBetween($arg1.toLocalDate(), $arg2.toLocalDate()).getDays()"""
      })

    compiler (DateFeature) ("dt_internal_months_between", Nil, (SDateTime, SDateTime) :: MInt) implements codegen($cala, {
        val arg1 = quotedArg(0)
        val arg2 = quotedArg(1)
        s"""org.joda.time.Months.monthsBetween($arg1.toLocalDate(), $arg2.toLocalDate()).getMonths()"""
      })

    compiler (DateFeature) ("dt_internal_years_between", Nil, (SDateTime, SDateTime) :: MInt) implements codegen($cala, {
        val arg1 = quotedArg(0)
        val arg2 = quotedArg(1)
        s"""org.joda.time.Years.yearsBetween($arg1.toLocalDate(), $arg2.toLocalDate()).getYears()"""
      })
...
dt_internal_weekday(dt)"""
    ...
    static (DateFeature) ("daysBetween", Nil, (MDouble, MDouble) :: MInt) implements composite {
        val arg1 = quotedArg(0)
        val arg2 = quotedArg(1)
        s"""dt_internal_days_between(dt_internal($arg1), dt_internal($arg2))"""
      }

    static (DateFeature) ("monthsBetween", Nil, (MDouble, MDouble) :: MInt) implements composite {
        val arg1 = quotedArg(0)
        val arg2 = quotedArg(1)
        s"""dt_internal_months_between(dt_internal($arg1), dt_internal($arg2))"""
      }

    static (DateFeature) ("yearsBetween", Nil, (MDouble, MDouble) :: MInt) implements composite {
        val arg1 = quotedArg(0)
        val arg2 = quotedArg(1)
        s"""dt_internal_years_between(dt_internal($arg1), dt_internal($arg2))"""
      }
  }
